...
Route::prefix('listepartenaires')->group( function (){
    Route::get('/{id}',[\App\Http\Controllers\Api\ApiController::class,'getAllListepartenaire']);
});

Route::prefix('categoriepartenaire')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllCategoriepartenaire']);
});
...
Route::prefix('statistique1')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllStatistique1']);
});

Route::prefix('statistique2')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllStatistique2']);
});

Route::prefix('statistique3')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllStatistique3']);
});

Route::prefix('statistique4')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllStatistique4']);
});
...
Route::prefix('agencen')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllAgenceNon']);
});
...
Route::prefix('visiteuser')->group( function (){
    Route::post('/',[\App\Http\Controllers\Api\ApiController::class,'visite']);
});
...
Route::prefix('Pcagna')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllPcagna']);
});

Route::prefix('Personnels')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllPersonnels']);
});

Route::prefix('partenaires')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllPartenaires']);
});

Route::prefix('video')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getAllVideo']);
});

Route::prefix('rechercher')->group( function (){
    Route::get('/',[\App\Http\Controllers\Api\ApiController::class,'getRecherche']);
});