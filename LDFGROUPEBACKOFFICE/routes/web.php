...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::match(['get', 'post'], '/categoriepartenaires', [App\Http\Controllers\ParametrageController::class, 'categoriepartenaires'])->name('categoriepartenaires');

    Route::match(['get', 'post'], '/creercategoriepartenaires', [App\Http\Controllers\ParametrageController::class, 'creercategoriepartenaires'])->name('creercategoriepartenaires');

    Route::match(['get', 'post'], '/modifiercategoriepartenaires/{id}', [App\Http\Controllers\ParametrageController::class, 'modifiercategoriepartenaires'])->name('modifiercategoriepartenaires');

    Route::match(['get', 'post'], '/activecategoriepartenaires/{id}', [App\Http\Controllers\ParametrageController::class, 'activecategoriepartenaires'])->name('activecategoriepartenaires');

    Route::match(['get', 'post'], '/desactivecategoriepartenaires/{id}', [App\Http\Controllers\ParametrageController::class, 'desactivecategoriepartenaires'])->name('desactivecategoriepartenaires');
