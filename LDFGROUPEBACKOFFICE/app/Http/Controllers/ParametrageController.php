...
class ParametrageController extends Controller
{
    public function slide(){
        ...
        $slides = DB::table('slide')->orderby('id_slide','desc')->get();
   ...
   public function creationslide(Request $request){
    ...
    public function productservice(){
        ...
        $produits = DB::table('produit')->orderby('id_produit','desc')->get();
    ...
    public function actualite(){
        ...
        $actualites = DB::table('actualite')->join('categorie_activite','actualite.id_cat','categorie_activite.id_categ')->orderby('id_actualite','desc')->get();
...
//dd($categoriesactss);
    ...
    public function temoignanges(){
        ...
        $temoignanges = DB::table('temoignange')->orderBy('id_temoi', 'DESC')->get();
    ...
    public function categorieactivite(){
        ...
        $categorieactivites = DB::table('categorie_activite')->orderby('id_categ','desc')->get();
    ...
    public function gestionpage(){
        ...
        $gestiondepages = DB::table('gestion_page')->orderby('id_gest_page','desc')->get();
...
//dd($sousmenus);
    ...
    public function partenaire(){
        ...
        $partenaires = DB::table('partenaire')->join('categorie_partenaire','partenaire.id_categ','categorie_partenaire.id_categorie')->orderby('id_parte','desc')->get();
    ...
    public function creerpartenaire(Request $request){
        ...
        if ($request->isMethod('post')) {
            ...
            switch ($request->input('action')) {
                ...
                case 'Enregister':
					...
					$partenaire->id_categ = $data['type_part'];
        ...
        $categorieps = CategoriePartenaire::get();



        $categoriep = "<option selected disabled>Select</option>";
        foreach ($categorieps as $comp ) {
            $categoriep .= "<option value='".$comp->id_categorie."'>".$comp->libelle_categ."</option>";
        }

        return view('partenaires.creer',compact('categoriep'));
    }
    ...
    public function modifierpartenaire(Request $request, $id=null){
        ...
        if ($request->isMethod('post')) {
            ...
            'id_user' =>$idutil,'id_categ' =>$data['type_part']]);

            }else{

            Partenaire::where([['id_parte','=',$id]])->update(['titre_part' =>$data['titre_part'],'id_user' =>$idutil,'id_categ' =>$data['type_part']]);
            }
        ...
        $categoriepa = CategoriePartenaire::where([['id_categorie','=',$partenaire->id_categ]])->first();

        if (isset($categoriepa)){
            $categoriep = "<option value='".$categoriepa->id_categorie."'>".$categoriepa->libelle_categ."</option>";
        ...
        return view('partenaires.modifier',compact('partenaire','id','categoriep'));
    }
    ...
    public function categorieproduit(){
        ...
        $categorieproduits = DB::table('categorie_produit')->orderby('id_cat_prod','desc')->get();
    ...
    public function statistique(){
        ...
        $statistiques = DB::table('statistique')->orderby('id_stat','desc')->get();
    ...
    public function creerstatistique(Request $request){
		...
		$statistique->descr_stat = $data['descr_stat'];
    ...
    public function logo(){
        ...
        $logos = DB::table('logo')->orderby('id_logo','desc')->get();
    ...
    public function help(){
        ...
        $helps = DB::table('help')->orderby('id_help','desc')->get();
    ...
    public function article(){
        ...
        $articles = DB::table('article')->join('categorie_article','article.id_categ_article','categorie_article.id_cat_article')->orderby('id_article','desc')->get();
...
$filefront = $data['image_article'];
	if (!$filefront->isValid()) {
   		 throw new \Exception('Error on upload file: '.$filefront->getErrorMessage());

		return redirect('/modifierarticle/'.\App\Helpers\Crypt::UrlCrypt($id))->with('error','taille du fichier trop volumineux');
...
public function categorieagences(){
        ...
        $categorieagences = DB::table('categorie_agence')->orderby('id_cat_agence','desc')->get();
    ...
    public function creeragences(Request $request){
        ...
        if ($request->isMethod('post')) {
            ...
            $agence = new Agence();
	    if(isset($data['flag_affcher_map'])){
                if ($data['flag_affcher_map']=="on"){
                    $flag_affcher_map = 1;
                }else{
                    $flag_affcher_map = 0;
                }
            ...
            if(isset($data['flag_affcher_liste'])){
                if ($data['flag_affcher_liste']=="on"){
                    $flag_affcher_liste = 1;
                }else{
                    $flag_affcher_liste = 0;
                }
            }else{
                $flag_affcher_liste = 0;
            }
            ...
            $agence->flag_agence =  0;
	    $agence->flag_affcher_liste =  $flag_affcher_liste;
            $agence->flag_affcher_map =  $flag_affcher_map;
$agence->responsable_agence =  $data['responsable_agence'];
	    ...
	    if(isset($data['flag_affcher_map'])){
            ...
            if (isset($data['image_agence'])){
                ...
                Agence::where([['id_agence','=',$id]])->update(['type_agence' =>$data['type_agence'],'nom_agence' =>$data['nom_agence'],
                    ...
                    'id_user' =>$idutil,'ordre_agence' =>$data['ordre_agence'],'flag_affcher_liste'=>$flag_affcher_liste,'flag_affcher_map'=>$flag_affcher_map,'responsable_agence'=>$data['responsable_agence']]);
    ...
    public function products(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            if (isset($data['date1'])) {
                $date1 = $data['date1'];
                $condition = $condition . ' and date_click > ' . "'$date1'";
            }

            if (isset($data['date2'])) {
                $date2 = $data['date2'];
                $condition = $condition . ' and date_click < ' . "'$date2'";
            }

              $recherches = DB::select(
                DB::raw(
                   'SELECT libelle_cat_prod,titre_produit,nombre,date_click,id_prod from  vue_stat_click_produit
                    where 1=1 ' . $condition   ),
            );
            ...
            if(count($recherches)==0){
				 ...
				 foreach ($recherches as $ligne) {
					 $nbreEncour=$ligne->nombre;
					 if(isset($arrayRecherches[$ligne->id_prod]['nbre'])){
						$nbreEncour += $arrayRecherches[$ligne->id_prod]['nbre'];
					 }

					 $arrayRecherches[$ligne->id_prod]['ligne']=$ligne;
					 $arrayRecherches[$ligne->id_prod]["nbre"]=$nbreEncour;
      ...
      return view('products.index', compact('arrayRecherches','recherches','date1','date2'));
    }
    ...
    public function apercuproduits($id=null, $id1=null){
     ...
     return view('products.edit', compact('arrayRecherches','recherches'));
    }

    public function categoriepartenaires(){

        $categoriepartenaires = DB::table('categorie_partenaire')->get();

        return view('categoriepartenaires.index',compact('categoriepartenaires'));
    }

    public function creercategoriepartenaires(Request $request){
        ...
        if ($request->isMethod('post')) {
            ...
            $categoriepart = new CategoriePartenaire;

            $categoriepart->libelle_categ = $data['lib_categ'];
            $categoriepart->flag_cat = 1;


            $categoriepart->save();

            return redirect('/categoriepartenaires')->with('success','enregistrement effectué');

        }

        return view('categoriepartenaires.creer');
    }

    public function modifiercategoriepartenaires(Request $request, $id=null){


        $id =  \App\Helpers\Crypt::UrldeCrypt($id);
        $idutil = Auth::user()->id;

        $categoriepartenaire = DB::table('categorie_partenaire')->where([['id_categorie','=',$id]])->first();
        ...
        if ($request->isMethod('post')) {
            ...
            CategoriePartenaire::where([['id_categorie','=',$id]])->update(['libelle_categ' =>$data['lib_categ']]);

            return redirect('/categoriepartenaires')->with('success','modification effectué');
        }

        return view('categoriepartenaires.modifier',compact('categoriepartenaire','id'));
    }

    public function activecategoriepartenaires($id=null){

        $id =  \App\Helpers\Crypt::UrldeCrypt($id);

        CategoriePartenaire::where([['id_categorie','=',$id]])->update(['flag_cat' => 1]);

        return redirect('/categoriepartenaires')->with('success','modification effectué');

    }

    public function desactivecategoriepartenaires($id=null){
        $id =  \App\Helpers\Crypt::UrldeCrypt($id);

        CategoriePartenaire::where([['id_categorie','=',$id]])->update(['flag_cat' => 0]);
