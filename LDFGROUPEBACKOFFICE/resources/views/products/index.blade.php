                    ...
                    <div class="card card-custom" style="width: 100%">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products')}}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        Periode du : <input type="date" name="date1" value="{{$date1}}" class="form-control"/>

                                    </div>

                                    <div class="col-lg-6">
                                       Au : <input type="date" name="date2" value="{{$date2}}" class="form-control"/>
                                    </div>
