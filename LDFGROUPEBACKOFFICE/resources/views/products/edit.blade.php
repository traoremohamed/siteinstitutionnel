<table width="100%" border="1" cellspacing="0" cellpadding="0" class="encadre"  align="center">
    <tbody>
    <tr>
...
<table border="1" width="100%" class="table table-striped table-bordered dTableR encadre" cellspacing="0"
       cellpadding="4">
    ...
    <?php
    $i = 0;
    foreach ($arrayRecherches as $elt): $i++;  
    $recherche = $elt['ligne']
    ?>
