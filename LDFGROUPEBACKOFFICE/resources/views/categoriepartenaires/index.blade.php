            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                        ...
                        <tbody>
                        @foreach ($categoriepartenaires as $key => $categorieactivite)
                        <tr>
                            <td>{{ $categorieactivite->id_categorie }}</td>
                            <td>{{ $categorieactivite->libelle_categ }}</td>

                            <td>
                                <?php if($categorieactivite->flag_cat == 1){ ?>
                            ...
                            <td align="center">
                                ...
                                <a href="{{ route('modifiercategoriepartenaires',\App\Helpers\Crypt::UrlCrypt($categorieactivite->id_categorie)) }}" class="btn btn-warning btn-xs btn-clean btn-icon"
                                ...
                                <?php if($categorieactivite->flag_cat == 1){ ?>
                                    ...
                                    <label class="label label-lg label-warning label-inline"><a href="{{ route('modifiercategoriepartenaires',\App\Helpers\Crypt::UrlCrypt($categorieactivite->id_categorie)) }}"> Desactiver </a></label>

                                <?php }else{ ?>

                                    <label class="label label-lg label-success label-inline"><a href="{{ route('modifiercategoriepartenaires',\App\Helpers\Crypt::UrlCrypt($categorieactivite->id_categorie)) }}"> Active </a></label>
