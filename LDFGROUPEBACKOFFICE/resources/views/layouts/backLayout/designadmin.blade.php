                    ...
                    <ul class="menu-nav">
                        ...
                        <?php  if (strtoupper($naroles) == "CLIENT") {
                            ...
                            <a href="javascript:<?php echo $key; ?>;" class="menu-link menu-toggle">
										<span class="svg-icon1 menu-icon">
...
<script src="backend/assets/js/pages/crud/forms/editors/summernote.js?v=7.0.5"></script>
		<!--begin::Page Scripts(used by this page)-->
		<script src="backend/assets/js/pages/widgets.js?v=7.0.5"></script>
		<script src="backend/assets/js/pages/custom/profile/profile.js?v=7.0.5"></script>
		<!--end::Page Scripts-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="backend/assets/plugins/custom/flot/flot.bundle.js?v=7.0.5"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="backend/assets/js/pages/features/charts/flotcharts.js?v=7.0.5"></script>
		<!--end::Page Scripts-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="backend/assets/js/pages/features/charts/apexcharts.js?v=7.0.5"></script>
		<!--end::Page Scripts-->
