                        ...
                        <!--begin::Title-->
                            ...
                            <div class="form-group ">
                                <div class="captcha">
                                    ...
                                    <button type="button" class="btn" style="background-color: #<?php echo $couleur->mot_cle;?>; color:#fff;" class="reload" id="reload">
                                        &#x21bb;
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="text-center pt-2">
                                <input type="submit" id="kt_login_signin_submit" name="connecter"
                                       ...
                                       value="Se connecter" style="background-color: #<?php echo $couleur->mot_cle;?>; color:#fff;">
                            </div>
                            <!--end::Action-->
                        </form>
                        <!--end::Form-->
        ...
        <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #f6f6f6;">
            ...
            <?php if (isset($infosa->logo_logo)){?>
                <div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center"
                     style="background-image: url({{ asset('/frontend/logo/'. $infosa->logo_logo)}}); width:100%;"></div>
            <?php } ?>
