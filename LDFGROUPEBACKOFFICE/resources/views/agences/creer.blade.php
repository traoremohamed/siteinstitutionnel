...
<div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" placeholder="Nom et prenom du responsable" name="responsable_agence"  />
 ...
 <div class="col-lg-3">
                            ...
                            <input type="checkbox" class="form-control"  name="flag_affcher_map" checked>
                        </div>
                        <div class="col-lg-3">
                            <label>Afficher dans la liste:</label>
                            <input type="checkbox" class="form-control"  name="flag_affcher_liste" checked>
                        </div>
